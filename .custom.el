...
(custom-set-faces
 ...
 '(fringe ((((background dark) (type graphic)) (:foreground "#073642" :background "#586e75")) (((background dark) (type tty) (min-colors 256)) (:foreground "#262626" :background "#585858")) (((background dark) (type tty) (min-colors 16)) (:foreground "black" :background "brightgreen")) (((background dark) (type tty) (min-colors 8)) (:foreground "black" :background "green")) (((background light) (type graphic)) (:foreground "#eee8d5" :background "#93a1a1")) (((background light) (type tty) (min-colors 256)) (:foreground "#e4e4e4" :background "#8a8a8a")) (((background light) (type tty) (min-colors 16)) (:foreground "white" :background "brightcyan")) (((background light) (type tty) (min-colors 8)) (:foreground "white" :background "cyan"))))
 ...
 '(whitespace-line ((((background dark) (type graphic)) (:foreground nil :underline (:color "gray50" :style line))) (((background dark) (type tty) (min-colors 256)) (:foreground nil :underline (:color "gray50" :style line))) (((background dark) (type tty) (min-colors 16)) (:foreground nil :underline (:color "gray50" :style line))) (((background dark) (type tty) (min-colors 8)) (:foreground nil :underline (:color "gray50" :style line))) (((background light) (type graphic)) (:foreground nil :underline (:color "gray50" :style line))) (((background light) (type tty) (min-colors 256)) (:foreground nil :underline (:color "gray50" :style line))) (((background light) (type tty) (min-colors 16)) (:foreground nil :underline (:color "gray50" :style line))) (((background light) (type tty) (min-colors 8)) (:foreground nil :underline (:color "gray50" :style line)))))
