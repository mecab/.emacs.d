((anything status "installed" recipe
 ...
 (dash-functional status "installed" recipe
                  (:name dash-functional :auto-generated t :type elpa :description "Collection of useful combinators for Emacs Lisp" :repo
 ...
 (dumb-jump status "installed" recipe
            (:name dumb-jump :type github :pkgname "jacktasia/dumb-jump" :after nil :depends
                   (popup dash s f)))
 (edit-indirect status "installed" recipe
                (:name edit-indirect :auto-generated t :type elpa :description "Edit regions in separate buffers" :repo
                       ("melpa" . "https://melpa.org/packages/")
                       :minimum-emacs-version
                       (24 3)))
 ...
 (nvm status "installed" recipe
      (:name nvm :type elpa :after nil :depends
             (dash-functional f dash s)))
 ...
 (ssass-mode status "installed" recipe
             (:name ssass-mode :auto-generated t :type elpa :description "Edit Sass without a Turing Machine" :repo
                    ("melpa" . "https://melpa.org/packages/")
                    :minimum-emacs-version
                    (24 3)))
 ...
 (tide status "installed" recipe
       (:name tide :description "TypeScript IDE" :depends
              (typescript-mode flycheck dash)
              :type github :pkgname "ananthakumaran/tide"))
 ...
 (virtualenvwrapper status "installed" recipe
                    (:name virtualenvwrapper :type github :website "https://github.com/porterjamesj/virtualenvwrapper.el" :description "virtualenv tool for emacs" :pkgname "porterjamesj/virtualenvwrapper.el" :depends
                           (dash s)))
 (vue-html-mode status "installed" recipe
                (:name vue-html-mode :auto-generated t :type elpa :description "Major mode for editing Vue.js templates" :repo
                       ("melpa" . "https://melpa.org/packages/")))
 (vue-mode status "installed" recipe
           (:name vue-mode :auto-generated t :type elpa :description "Major mode for vue component based on mmm-mode" :repo
                  ("melpa" . "https://melpa.org/packages/")
                  :depends
                  (mmm-mode vue-html-mode ssass-mode edit-indirect)))
